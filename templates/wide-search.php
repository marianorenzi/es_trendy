...
if ( ! empty( $es_trendy_options->search_background_id ) ) {
	$search_background       = wp_get_attachment_image_src( $es_trendy_options->search_background_id, 'original' );
...
?>
<div class="search--wide search--wide-black">
...
<div class="search--wide search--wide-color">
    <div class="search--compact-blur" style="background-image: url(<?php echo $search_background_image; ?>);"></div>
    <div class="search--compact-wrapper">
        <div class="left-container">
